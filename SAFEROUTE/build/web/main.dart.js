...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  dart.defineLazy(CT, {
    ...
    get C9() {
      return C[9] = dart.const({
        __proto__: main.SafeRouteHome.prototype,
        [Widget_key]: null
      });
    },
    get C1() {
    ...
    get C14() {
      return C[14] = dart.const({
        ...
        [Text_style]: null,
        [Text_textSpan]: null,
        [Text_data]: "Enter both locations"
      });
    },
    get C10() {
      return C[10] = dart.const({
        ...
        [Widget_key]: null,
        [SnackBar_clipBehavior]: C[11] || CT.C11,
        [SnackBar_dismissDirection]: C[12] || CT.C12,
        [SnackBar_onVisible]: null,
        [SnackBar_animation]: null,
        [SnackBar_duration]: C[13] || CT.C13,
    ...
    get C18() {
      return C[18] = dart.const({
        ...
        [Text_textSpan]: null,
        [Text_data]: "🛡️ One-Tap Safety Audit"
      });
    },
    get C21() {
    ...
    get C22() {
      return C[22] = dart.const({
        ...
        [InputDecoration_prefixIcon]: C[23] || CT.C23,
        ...
        [InputDecoration_labelText]: "From",
    ...
    get C26() {
      return C[26] = dart.const({
        ...
        [InputDecoration_prefix]: null,
        [InputDecoration_prefixIconConstraints]: null,
        [InputDecoration_prefixIcon]: C[27] || CT.C27,
        [InputDecoration_isCollapsed]: false,
        [InputDecoration_contentPadding]: null,
        [InputDecoration_isDense]: null,
        [InputDecoration_floatingLabelAlignment]: null,
    ...
    get C30() {
      return C[30] = dart.const({
        ...
        [CircularProgressIndicator__indicatorType]: C[31] || CT.C31
      });
    },
    get C32() {
    ...
    get C41() {
      return C[41] = dart.const({
        __proto__: main.SafeRouteApp.prototype,
        [Widget_key]: null
      });
    },
    get C42() {
  ...
  main.SafeRouteApp = class SafeRouteApp extends framework.StatelessWidget {
    static ['_#new#tearOff'](opts) {
      let key = opts && 'key' in opts ? opts.key : null;
      return new main.SafeRouteApp.new({key: key});
    }
    build(context) {
      return C[1] || CT.C1;
    }
  };
  (main.SafeRouteApp.new = function(opts) {
    let key = opts && 'key' in opts ? opts.key : null;
    main.SafeRouteApp.__proto__.new.call(this, {key: key});
    ;
  }).prototype = main.SafeRouteApp.prototype;
  dart.addTypeTests(main.SafeRouteApp);
  dart.addTypeCaches(main.SafeRouteApp);
  dart.setMethodSignature(main.SafeRouteApp, () => ({
    __proto__: dart.getMethods(main.SafeRouteApp.__proto__),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(main.SafeRouteApp, I[0]);
  main.SafeRouteHome = class SafeRouteHome extends framework.StatefulWidget {
    static ['_#new#tearOff'](opts) {
      let key = opts && 'key' in opts ? opts.key : null;
      return new main.SafeRouteHome.new({key: key});
    }
    createState() {
      return new main._SafeRouteHomeState.new();
    }
  };
  (main.SafeRouteHome.new = function(opts) {
    let key = opts && 'key' in opts ? opts.key : null;
    main.SafeRouteHome.__proto__.new.call(this, {key: key});
    ;
  }).prototype = main.SafeRouteHome.prototype;
  dart.addTypeTests(main.SafeRouteHome);
  dart.addTypeCaches(main.SafeRouteHome);
  dart.setMethodSignature(main.SafeRouteHome, () => ({
    __proto__: dart.getMethods(main.SafeRouteHome.__proto__),
    createState: dart.fnType(framework.State$(main.SafeRouteHome), [])
  }));
  dart.setLibraryUri(main.SafeRouteHome, I[0]);
  ...
  main._SafeRouteHomeState = class _SafeRouteHomeState extends framework.State$(main.SafeRouteHome) {
    checkSafety() {
      return async.async(dart.void, (function* checkSafety() {
        if (this.fromController.text[$isEmpty] || this.toController.text[$isEmpty]) {
          scaffold.ScaffoldMessenger.of(this.context).showSnackBar(C[10] || CT.C10);
          return;
        }
        ...
        yield async.Future.delayed(C[15] || CT.C15);
        this.setState(dart.fn(() => {
          this.safetyScore = 7;
          this.riskLevel = "Medium";
          this.routeSummary = "Prefer main roads with shops and avoid isolated streets.";
          this.tips = T.JSArrayOfString().of(["Avoid poorly lit areas", "Stay near crowded places", "Keep emergency contacts ready"]);
          this.loading = false;
    ...
    openMap() {
      let from = core.Uri.encodeComponent(this.fromController.text);
      let to = core.Uri.encodeComponent(this.toController.text);
      let url = "https://www.google.com/maps/dir/" + from + "/" + to;
      html.window[$open](url, "_blank");
    }
    scoreColor() {
      if (this.safetyScore >= 8) return colors.Colors.green;
      if (this.safetyScore >= 5) return colors.Colors.orange;
      return colors.Colors.red;
    }
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: C[16] || CT.C16, centerTitle: true}), body: new basic.Padding.new({padding: C[17] || CT.C17, child: new basic.Column.new({children: (() => {
              let t0 = T.JSArrayOfWidget().of([C[18] || CT.C18, C[21] || CT.C21, new text_field.TextField.new({controller: this.fromController, decoration: C[22] || CT.C22}), C[25] || CT.C25, new text_field.TextField.new({controller: this.toController, decoration: C[26] || CT.C26}), C[29] || CT.C29, new basic.Row.new({children: T.JSArrayOfWidget().of([new basic.Expanded.new({child: new elevated_button.ElevatedButton.new({onPressed: this.loading ? null : dart.bind(this, 'checkSafety'), child: this.loading ? C[30] || CT.C30 : C[32] || CT.C32})}), C[33] || CT.C33, new elevated_button._ElevatedButtonWithIcon.new({onPressed: dart.bind(this, 'openMap'), icon: C[34] || CT.C34, label: C[36] || CT.C36, style: elevated_button.ElevatedButton.styleFrom({backgroundColor: colors.Colors.green})})])}), C[21] || CT.C21]);
              if (this.showResult) t0.push(new card.Card.new({child: new basic.Padding.new({padding: C[17] || CT.C17, child: new basic.Column.new({children: (() => {
                      let t1 = T.JSArrayOfWidget().of([C[37] || CT.C37, C[38] || CT.C38, new circle_avatar.CircleAvatar.new({radius: 40, backgroundColor: this.scoreColor(), child: new text.Text.new(dart.str(this.safetyScore), {style: C[39] || CT.C39})}), C[38] || CT.C38, new text.Text.new("Risk Level: " + this.riskLevel), C[40] || CT.C40, new text.Text.new(this.routeSummary), C[38] || CT.C38]);
                      t1[$addAll](this.tips[$map](framework.Widget, dart.fn(t => new text.Text.new("• " + t), T.StringToText())));
                      return t1;
                    })()})})}));
              return t0;
            })()})})});
  ...
  (main._SafeRouteHomeState.new = function() {
    this.fromController = new editable_text.TextEditingController.new();
    this.toController = new editable_text.TextEditingController.new();
    this.loading = false;
    this.showResult = false;
    this.safetyScore = 0;
    this.riskLevel = "";
    this.routeSummary = "";
    this.tips = T.JSArrayOfString().of([]);
    main._SafeRouteHomeState.__proto__.new.call(this);
    ;
  }).prototype = main._SafeRouteHomeState.prototype;
  dart.addTypeTests(main._SafeRouteHomeState);
  dart.addTypeCaches(main._SafeRouteHomeState);
  dart.setMethodSignature(main._SafeRouteHomeState, () => ({
    __proto__: dart.getMethods(main._SafeRouteHomeState.__proto__),
    checkSafety: dart.fnType(async.Future$(dart.void), []),
    openMap: dart.fnType(dart.void, []),
    scoreColor: dart.fnType(ui.Color, []),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(main._SafeRouteHomeState, I[0]);
  dart.setFieldSignature(main._SafeRouteHomeState, () => ({
    __proto__: dart.getFields(main._SafeRouteHomeState.__proto__),
    fromController: dart.finalFieldType(editable_text.TextEditingController),
    toController: dart.finalFieldType(editable_text.TextEditingController),
    loading: dart.fieldType(core.bool),
    showResult: dart.fieldType(core.bool),
    safetyScore: dart.fieldType(core.int),
    riskLevel: dart.fieldType(core.String),
    routeSummary: dart.fieldType(core.String),
    tips: dart.fieldType(core.List$(core.String))
  }));
